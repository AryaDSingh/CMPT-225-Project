...
int main() {
 ...
 //float float_type = 1.111;
  ...
  double time_taken_Vec_insert = elapsed_time(startVec_insert,finishVec_insert);
  double time_taken_Vec = elapsed_time(startVec_visit,finishVec_visit);
